...
export const TRANSLATIONS = {
  es: {
    ...
    portfolio: {
      ...
      cats: ['Limpieza Láser y Restauración'],
      tags: ['Restauración de superficies'],
      soonLabel: 'Próximamente',
      soonTitle: 'Más proyectos en camino',
      soonCta: '¿El tuyo puede ser el próximo? →',
    },
    process: {
    ...
    about: {
      ...
      qa: [
        ...
        { q: '¿Dónde están?', a: 'Operamos de forma 100% remota desde Argentina y atendemos clientes de cualquier país. Coordinamos por WhatsApp, videollamada o el canal que te resulte más cómodo.' },
  ...
  en: {
    ...
    portfolio: {
      ...
      cats: ['Laser Cleaning & Restoration'],
      tags: ['Surface restoration'],
      soonLabel: 'Coming soon',
      soonTitle: 'More projects on the way',
      soonCta: 'Could yours be next? →',
    },
    process: {
      label: 'How we work',
      title: 'Simple, clear',
    ...
    about: {
      ...
      qa: [
        ...
        { q: 'Where are you based?', a: 'We operate fully remotely from Argentina and work with clients in any country. We coordinate via WhatsApp, video call or whichever channel suits you best.' },
